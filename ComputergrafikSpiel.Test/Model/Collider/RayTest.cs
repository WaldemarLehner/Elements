...
namespace ComputergrafikSpiel.Test.Model.Collider
{
    ...
    public class RayTest
    {
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new Ray(Vector2.Zero, Vector2.Zero, 1));
        }
        [DataTestMethod]
        [DataRow(0)]
        [DataRow(-1)]
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new Ray(Vector2.Zero, Vector2.One, maxDis));
        }
        [DataTestMethod]
        [DataRow(4, 2, 0)]
        [DataRow(4, 3, 1)]
        ...
        public void AssertThatMinimalDistanceToIsCalculatedCorrectly(float tileLocX, float tileLocY, float trueDistance)
        {
            ...
            Ray testRay = new Ray(rayTestPosition, rayTestDirection, maxDis);
